...
public class escaparfuerzasimpreriales_BEST {
	...
	public static boolean camino(char mapa[][], int x, int y) {
		...
		if (mapa[x][y] == '.') {
			...
			// Probamos Arriba
				...
				return true;
			// Si ningun camino posible bloqueamos esa posici�n del mapa
			else {
				return false;
			}
		}
		...
		// Otro caso no deber�a darse nunca
		return false;
	}
